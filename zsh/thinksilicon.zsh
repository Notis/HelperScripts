...
export PATH=$PATH:/opt/Xilinx/14.4/ISE_DS/ISE/bin/lin64
export PATH=$PATH:/opt/Xilinx/14.4/ISE_DS/EDK/bin/lin64
export PATH=$PATH:/opt/Xilinx/14.4/ISE_DS/common/bin/lin
export PATH=$PATH:/opt/Xilinx/14.4/ISE_DS/PlanAhead/bin/
